...
You are absolutely right to be careful about that. If the ``` (three backticks) are missing at the end, everything below it will disappear into the code block.

In the code below, I have ensured every Mermaid block ends with ``` before the </details> tag closes.

Here is the final, safe version. You can copy this entire block and it will work perfectly.
